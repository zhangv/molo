 ...
 * file.
 */
public final class VectorDumper2 extends AbstractJob {

  private static final Logger log = LoggerFactory.getLogger(VectorDumper2.class);

  public VectorDumper2() {
  }
  ...
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new Configuration(), new VectorDumper2(), args);
  }
